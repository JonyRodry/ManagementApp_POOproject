...
/**
 * Classe que extende a classe abstrata Bolseiro e representa um Licenciado inscrito no CISUC
 * <p>
 ...
 */
class Licenciado extends Bolseiro implements Serializable{
    private int custo = 800;
    private int nProj = 0;
    
    /**
    * Construtor da classe Licenciado.
    * Esta função cria um novo Licenciado com os dados recebidos.
    ...
    * @author      João Rodrigues
    */
    public Licenciado(String nome, String email, String dataInicial, String dataFinal) {
        super(nome, email, dataInicial, dataFinal);
    }

    /**
    * Retorna um inteiro com o custo do Licenciado
